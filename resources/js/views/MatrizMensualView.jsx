...
export default function MatrizMensualView() {
  ...
  function calculateModalPreview(item) {
    ...
    if (soloEntradaSalida) {
      ...
      const esPartTime = (turno_nombre === 'PART_TIME') || (turno_nombre === 'AUTO' && totalTrabajados <= 330) || (turnoDetectado === 'PART_TIME');
      ...
      if (esPartTime) {
        ...
        return {
          ...
          calcExtra: totalExtras,
          isIncomplete: false,
          calcTurno: turno_nombre !== 'AUTO' ? turno_nombre : 'SIN_RESTRICCIONES',
    ...
    if (turno_nombre === 'PART_TIME' || turnoDetectado === 'PART_TIME') {
